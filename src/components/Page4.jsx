...
const Page4 = () => {
  return (
    <div className=' md:min-h-screen items-center'>
        <div className='flex justify-center text-[#FAFAFA] tracking-wider font-light md:text-xl py-10 mt-32 items-center'>
            <div className='w-[80%] md:w-[70%] justify-center items-center'>
                <div className='flex justify-center'>
                    <h1 className='text-3xl font-bold p-8 md:p-16'>Key Features</h1>
                </div>
                <div className='grid md:grid-cols-3 gap-8 items-center'>
                    <div className='flex flex-col justify-center items-center p-2' >
                        <h1 className='text-2xl md:text-3xl py-2 md:py-6'>Vehicle Customization</h1>
                    ...
                    <div className='flex flex-col justify-center items-center p-2'>
                        <h1 className='text-2xl md:text-3xl py-2 md:py-6'>Engaging  Storyline</h1>
                    ...
                    <div className='flex flex-col justify-center items-center p-2'>
                        <h1 className='text-2xl md:text-3xl py-2 md:py-6'>Day-Night Cycle</h1>
